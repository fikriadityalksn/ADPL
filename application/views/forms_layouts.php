<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="<?php echo base_url() .'index.php/createDataDasar'?>">Data Dasar Puskesmas</a></li>
		</ol>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Data Dasar Puskesmas</span>
				</div>
				<div class="box-icons">
			...
			<div class="box-content">
				<h4 class="page-header">1. Identitas</h4>
				<form class="form-horizontal" role="form">
				<?php echo form_open(base_url('index.php/MyController/createdatadasar')); ?>  

					<div class="form-group">

					<label class="col-sm-2 control-label">Kode Puskesmas</label>
						<div class="col-sm-4">
							<input type="text" name="kode_puskes" class="form-control" placeholder="Kode Puskesmas"  data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
						<label class="col-sm-2 control-label">Nama Puskesmas</label>
						<div class="col-sm-4">
							<input type="text" name="nama_puskes" class="form-control" placeholder="Nama Puskesmas" data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
						</div>
						<label class="col-sm-2 control-label">Alamat</label>
						<div class="col-sm-4">
							<input type="text" name="alamat" class="form-control" placeholder="Alamat"  data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
						<label class="col-sm-2 control-label">Jenis Puskesmas</label>
						<div class="col-sm-4">
							<select id="s2_with_tag" name="jenis_puskes" class="populate placeholder">
								<option>Linux</option>
						...
						<h4 style="color: grey">W I L A Y A H</h4>
						...
						<label class="col-sm-2 control-label">No Telfon</label>
						<div class="col-sm-4">
							<input type="text" name="tlep" class="form-control" placeholder="No Telfon Puskesmas" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
						...
						<div class="col-sm-4">
							<input type="text" name="fax" class="form-control" placeholder="Fax" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
						<label class="col-sm-2 control-label">Kodepos</label>
						<div class="col-sm-4">
							<input type="text" name="kodepos" class="form-control" placeholder="Kodepos" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
						</div>
						</div>
						<!-- </form> -->
						...
						<div class="box-content">
				<h4 class="page-header">2. Kondisi Puskesmas</h4>
				<form class="form-horizontal" role="form">
					<div class="form-group">
						<label class="col-sm-2 control-label">Kondisi Bangunan</label>
						<div class="col-sm-4">
							<select id="s2_with_tag" name="kondisi_bangunan" class="populate placeholder">
								<option>Baik</option>
						...
						<div class="col-sm-4">
							<select name="status_akreditasi" class="populate placeholder">
								<option>Telah Terakreditasi</option>
								<option>Dalam Proses Akreditasi</option>
					...
					<h4 class="page-header">3. Ketenagaan Puskesmas</h4>
				<form class="form-horizontal" role="form">
					<div class="form-group">

					<label class="col-sm-2 control-label">Dokter</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_dokter" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">Dokter Gigi</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_doktergigi" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">Perawat</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_perawat" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">Bidan</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_bidan" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">T.K. Kemasyarakatan</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_TKM" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">T.K. Lingkungan</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_TKL" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
						<!-- <label class="col-sm-2 control-label">cek</label>
 -->
					<label class="col-sm-2 control-label">Ahli Gizi</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_ahliGizi" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">Ahli Laboraturium</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_ahliLab" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">farmasi</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_farmasi" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
						
						
						<label class="col-sm-2 control-label">Jumlah Tenaga Penunjang</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_tenagapenunjang" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
					<label class="col-sm-2 control-label">Total Tenaga di Puskesmas</label>
						<div class="col-sm-2">
							<input type="text" name="jumlah_tenaga" class="form-control" placeholder="">
							<span class="fa fa-key txt-warning form-control-feedback"></span>
						</div>
						<br>
						<br>
