<html><head>
                    ...
                    <div class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo base_url().'index.php/petarumahsakit'?>">Rumah sakit</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url().'index.php/maps'?>">Puskesmas</a>
                                    </li>
        ...
        <section id="blog" class="container">
            <body>
<div id="scroller">
<iframe name="myiframe" id="myiframe" src="<?php echo base_url().'assets/front/organisasi/perbup.pdf'?>" style="width: 100%;height: 100%;border: none;"> </iframe>
</div>
        </section>
        <!--/#blog-->
