        ...
        <div class="span6">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <?php echo form_open(base_url('index.php/MyControllerAP/do_updatePegawai')); ?> 
              <form action="#" method="get" class="form-horizontal">
                <div class="control-group">
                  <label class="control-label"><br>NIP :</label>
                  <div class="controls">
                    <input type="text" name="nip" class="span11" placeholder="NIP" value="<?php echo $nip ?>"><br><br>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Nama :</label>
                  <div class="controls">
                    <input type="text"  name="nama" class="span11" placeholder="Nama" value="<?php echo $nama ?>">
                  </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="golongan_terakhir" class="span11" placeholder="Golongan Terakhir" value="<?php echo $golongan_terakhir ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Pendidikan Pertama :</label>
                  <div class="controls">
                    <input type="text" name="pendidikan_pertama" class="span11" placeholder="Pendidikan Pertama" value="<?php echo $pendidikan_pertama ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Pendidikan Terakhir :</label>
                  <div class="controls">
                    <input type="text" name="pendidikan_terakhir" class="span11" placeholder="Pendidikan Terakhir" value="<?php echo $pendidikan_terakhir ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Eselon :</label>
                  <div class="controls">
                    <input type="text" name="eselon" class="span11" placeholder="Eselon" value="<?php echo $eselon ?>">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="gol_jabatan" class="span11" placeholder="Golongan Jabatan" value="<?php echo $gol_jabatan ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Unit Kerja</label>
                  <div class="controls">
                    <input type="text" name="unit_kerja" class="span11" placeholder="Unit" value="<?php echo $unit_kerja ?>">
                  </div>
                </div>
