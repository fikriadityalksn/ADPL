    ...
    <div class="row-fluid">
      <div class="span6">
        <div class="widget-box">
          ...
          <?php echo form_open(base_url('index.php/MyControllerAP/do_updateDataDasar')); ?>
            <form action="#" method="get" class="form-horizontal">
              <div class="control-group">
                <label class="control-label"><br>Kode Puskesmas :</label>
                <div class="controls">
                <input type="text" name="kode_puskes" class="span11" placeholder="Kode Puskesmas" value="<?php echo $kode_puskes ?>"><br><br>  
              ...
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text"  name="nama_puskes" class="span11" placeholder="Nama Puskesmas" value="<?php echo $nama_puskes ?>">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jenis_puskes" class="span11" placeholder="Jenis Puskesmas" value="<?php echo $jenis_puskes ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="kecamatan" class="span11" placeholder="kecamatan" value="<?php echo $kecamatan ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="desa" class="span11" placeholder="desa" value="<?php echo $desa ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="latitude" class="span11" placeholder="Posisi Latitude" value="<?php echo $latitude ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="longtitude" class="span11" placeholder="Posisi Longtitude" value="<?php echo $longtitude ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="kodepos" class="span11" placeholder="Kode Pos" value="<?php echo $kodepos ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
               <input type="email" name="email" class="span11" placeholder="Email" value="<?php echo $email ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="fax" class="span11" placeholder="Fax" value="<?php echo $fax ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
               <input type="text" name="tlep" class="span11" class="span11" placeholder="No Telfon" value="<?php echo $tlep ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="kondisi_bangunan" class="span11" class="span11" placeholder="Kondisi Bangunan" value="<?php echo $kondisi_bangunan ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="status_akreditasi" class="span11" placeholder="Status Akreditasi" value="<?php echo $status_akreditasi ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_dokter" class="span11" placeholder="Jumlah Dokter" value="<?php echo $jumlah_dokter ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_doktergigi" class="span11" placeholder="Jumlah Dokter Gigi" value="<?php echo $jumlah_doktergigi ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_perawat" class="span11" placeholder="Jumlah Perawat" value="<?php echo $jumlah_perawat ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_bidan" class="span11" placeholder="Jumlah Bidan" value="<?php echo $jumlah_bidan ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_TKM" class="span11" placeholder="Jumlah Tenaga Kesehatan Masyarakat" value="<?php echo $jumlah_TKM ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_TKL" class="span11" placeholder="Jumlah Tenaga Kesahatan Lingkungan" value="<?php echo $jumlah_TKL ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
               <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_ahliGizi" class="span11" placeholder="Jumlah Tenaga Gizi" value="<?php echo $jumlah_ahliGizi ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_ahliLab" class="span11" placeholder="Jumlah ahli Lab" value="<?php echo $jumlah_ahliLab ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div><div class="control-group">
                <label class="control-label">Jumlah Farmasi</label>
                <div class="controls">
                <input type="text" name="jumlah_farmasi" class="span11" placeholder="Jumlah Farmasi" value="<?php echo $jumlah_farmasi ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_tenagapenunjang" class="span11" placeholder="Jumlah Tenaga Penunjang" value="<?php echo $jumlah_tenagapenunjang ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="jumlah_tenaga" class="span11" placeholder="Jumlah Tenaga Keseluruhan" value="<?php echo $jumlah_tenaga ?>">
                  <!-- <input type="password"  class="span11" placeholder="Enter Password"  /> -->
                </div>
              </div>
